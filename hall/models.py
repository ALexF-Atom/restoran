...
class Table(models.Model):
    ...
    y_coordinate = ProcentField(verbose_name="Расположение по вертикали", min_value=0, max_value=100)
    x_coordinate = ProcentField(verbose_name="Расположение по горизонтали", min_value=0, max_value=100)
    width = ProcentField(verbose_name="Размер по горизонтали", min_value=1, max_value=100)
    length = ProcentField(verbose_name="Размер по вертикали", min_value=1, max_value=100)
    #get_shape_display
    shape = models.SmallIntegerField(verbose_name="Форма", default=1, choices=SHAPES)
